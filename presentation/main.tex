...
\begin{document}
    ...
    \begin{frame}{Eigenschaften der Äquivarianzgleichungen}
        \begin{itemize}
            \item \textbf{Theorem:} Die Äquivarianzgleichungen sind \alert{involutiv} und folglich \alert{formal integrierbar}. \pause
    ...
    \begin{frame}{Exakte Lösung: Einstein}
        \begin{itemize}
            \item Zweites Jet-Bündel über dem metrischen Tensorbündel hat Dimension $4+10+40+100 = 154$ ($\operatorname{dim}M = 4$) \pause
            \item Äquivarianzgleichungen sind involutiv und haben Rang 136 \pause
            \item $\Rightarrow$ allgemeine Lösung ist von der Form
            \[ L(x,g,\partial g,\partial\partial g) = \sqrt{-g} \cdot F(\psi_1,\ldots,\psi_14) \]
            mit beliebiger Funktion $F$ und 14 Krümmungsskalaren $\Psi_i(g,\partial g,\partial\partial g)$
        \end{itemize}
    \end{frame}
