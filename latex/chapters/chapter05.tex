...
\begin{equation}
  \mathrm{id} = T\otimes n + e_\alpha \otimes \epsilon^\alpha,
\end{equation}
a vector field $v$ decomposes as
\begin{equation}
  v = v\circ \mathrm{id} = v(n)\, T + v(\epsilon^\alpha)\, e_\alpha,
\end{equation}
such that the holonomic components are determined by observer quantities $N$, $N^\alpha$, $v(n)$, $v(\epsilon^\alpha)$ as
\begin{equation}
  v(\mathrm dt) = v(n)\quad\text{and}\quad v(\mathrm dx^\alpha) = -\frac{1}{N}N^\alpha v(n) + v(\epsilon^\alpha).
\end{equation}
For the area metric field, we obtain a similar decomposition
\begin{gather}
  ...
  \begin{aligned}
    G(\mathrm dx^\alpha, \mathrm dx^\beta, \mathrm dx^\gamma, \mathrm dx^\delta) &{} = \frac{4}{N^2} N^{\lbrack\alpha}G(n,\epsilon^{\beta\rbrack},n,\epsilon^{\lbrack\delta})N^{\gamma\rbrack} + \frac{2}{N} N^{\lbrack\alpha}G(n,\epsilon^{\beta\rbrack},\epsilon^\gamma,\epsilon^\delta) \\
                                                                                 &{} = + \frac{2}{N} N^{\lbrack\gamma}G(n,\epsilon^{\delta\rbrack},\epsilon^\alpha,\epsilon^\beta) + G(\epsilon^\alpha,\epsilon^\beta,\epsilon^\gamma,\epsilon^\delta),
  \end{aligned}
\end{gather}
