...
\end{equation}
with $C^{i\hphantom jn}_{\hphantom ij\hphantom nm} = \delta^i_m \delta^n_j$ for vectors and $C_{i\hphantom{jn}m}^{\hphantom ijn}=\delta^n_i\delta^j_m$ for covectors.
