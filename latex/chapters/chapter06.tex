...
\begin{equation}
  M^{\alpha\beta} = \begin{pmatrix}\operatorname{cos}(\varphi) & \operatorname{sinn}(\varphi) & 0 \\ \operatorname{sin}(\varphi)  & - \operatorname{cos}(\varphi) & 0 \\ 0 & 0 & 1\end{pmatrix}^{\alpha\beta}
\end{equation}
...
Transforming $M^{\alpha\beta}$ accordingly and projecting onto the different (TT, vector, scalar) contributions, we obtain the transverse traceless tensor
\begin{equation}
