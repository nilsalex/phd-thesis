\begin{abstract}
  ...
  For novel matter theories that may couple to nonmetric geometries, two axioms guide the completion: diffeomorphism invariance of gravity and causal compatibility of gravity with the matter theory. Both notions have a strong mathematical basis, which is presented first, before formulating precise definitions of the axioms. The implementation of the axioms for specific geometries follows a pattern that is to a certain degree independent of the geometry. This pattern is stated in the condensed form of an algorithm. Since this algorithm provides a construction procedure for gravitational theories on the basis of general covariance, it is called \emph{covariant constructive gravity}---highlighting both the similarities with and differences to (canonical) constructive gravity.
