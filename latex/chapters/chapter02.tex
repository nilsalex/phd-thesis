...
\end{proof}
A useful corollary of the homomorphism property of the Lie algebra lift $\xi\mapsto\xi_E$, which will play a role in Sect.~\ref{sect_involution}, is the following fact about Gotay-Marsden coefficients.
\begin{corollary}
