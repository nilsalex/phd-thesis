...
\begin{document}
    ...
    \begin{frame}{Eigenschaften der Äquivarianzgleichungen}
        \begin{itemize}
            ...
            \item Ergebnis ist von fundamentaler Bedeutung für den konstruktiven Ansatz
            \begin{itemize}
    ...
    \begin{frame}{Neuartige Materie}
        ...
        \[ L = {\color{red}\sqrt{-g} g^{ab}} \phi_{,a}\phi_{,b} - m_\phi^2 \phi^2 + {\color{blue}\sqrt{-h} h^{ab}} \psi_{,a}\psi_{,b} - m_\psi^2 \psi^2 \]} \pause
        \begin{itemize}
