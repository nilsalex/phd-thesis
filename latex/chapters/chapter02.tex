...
\end{proof}
A useful corollary of the homomorphism property of the Lie algebra lift $\xi\mapsto\xi_E$ is the following fact about Gotay-Marsden coefficients.
\begin{corollary}
  Let $C^{A\hphantom Bn}_{\hphantom AB\hphantom nm}$ denote the Gotay-Marsden coefficients corresponding to a tensor field theory. The identity
  \begin{equation}
    C^{A\hphantom Bn}_{\hphantom AB\hphantom nm}
  \end{equation}
\end{corollary}
