...
\begin{equation*}
  \varphi_{\alpha\beta}^{\mathrm{TT}} = \underbrace{\frac{4\eta}{c^4R} \frac{(Gm)^2}{r}}_{\vcentcolon= 2d} M_{\alpha\beta}^{\mathrm{TT}}.
\end{equation*}
