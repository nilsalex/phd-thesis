...
\newpage
With the linearly independent subset \eqref{eq_linearized_eom_constants} of gravitational constants, the scalar field equations read \\
\vspace{\baselineskip}
\resizebox{\linewidth}{!}{%
