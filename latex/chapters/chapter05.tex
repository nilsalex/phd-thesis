...
Unfortunately, the second-order expansion of the GLED principal polynomial is not effectively metric anymore. The straightforward way of applying the Legendre transform---lowering indices with the covariant metric---is not available in this case. In fact, there is no closed expression for the Legendre transform corresponding to a quartic polynomial.\cite{sergio??} While it is certainly possible to treat the problem perturbatively, it is considered out of scope for the purpose of this thesis. After all, we do not seek to derive a comprehensive solution, but rather demonstrate how the introduction of novel matter dynamics has ramifications on the gravitational sector of the theory. The results for the massless transverse traceless tensor modes, as well as the massive tracefree modes, already allow to make nontrivial predictions concerning the phenomenology of a binary star, such that more extensive knowledge of the remaining scalar modes is deemed dispensable.
