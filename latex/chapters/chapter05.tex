...
\end{equation}
Performing a spatial Fourier transform of the system \label{coupled_wave_equations}, we can translate it into a system of linear, first-order ordinary differential equations for the modes $\tilde v(t,k)$ and $\tilde w(t,k)$
\begin{equation}
...
\begin{equation}
  \lambda = \pm \mathrm i \sqrt{(k^2 + \nu^2) \pm \mathrm i\sigma}.
\end{equation}
From this observation, we derive a second condition for the gravitational constants to yield a theory with plausible phenomenology: 
